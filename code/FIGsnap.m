...
hold on
set(gca, 'YScale', 'log')
plot(snapshots,Errors_p_m(2,:),'-o','LineWidth',2, 'markersize', 10);
set(gca, 'ColorOrderIndex', get(gca, 'ColorOrderIndex')+1);
plot(snapshots,Errors_p_m(1,:),'--x','LineWidth',2, 'markersize', 10);
plot(snapshots,Errors_p_m(3,:),':s','LineWidth',2, 'markersize', 10);
...
hold on
set(gca, 'YScale', 'log')
plot(snapshots,Errors_q_m(2,:),'-o','LineWidth',2, 'markersize', 10);
set(gca, 'ColorOrderIndex', get(gca, 'ColorOrderIndex')+1);
plot(snapshots,Errors_q_m(1,:),'--x','LineWidth',2, 'markersize', 10);
plot(snapshots,Errors_q_m(3,:),':s','LineWidth',2, 'markersize', 10);
